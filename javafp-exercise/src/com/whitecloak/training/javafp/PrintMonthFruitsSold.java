...
public class PrintMonthFruitsSold {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Print what month the **Fruits** are sold the most");
        printMonthFruitsSold(pathManila, pathCebu, pathDavao);
    }

    private static void printMonthFruitsSold(Path pathManila, Path pathCebu, Path pathDavao) throws IOException {
        ...
        String monthWithMostFruitsSold = itemStream.filter(line -> !line.isBlank())
                ...
                .filter(itemModel -> itemModel.getName().equals("Fruits"))
        ...
        System.out.println(Month.of(Integer.parseInt(monthWithMostFruitsSold)));
    }
}